...
export type ItemRef = components['schemas']['CatalogItemRef'];

/** One day's average price for one item. */
export type DailyPricePoint = components['schemas']['DailyPricePoint'];

/** Response row of `client.priceStats.daily()`. */
export type ItemDailyStats = components['schemas']['ItemDailyStats'];

export type EstimatedValue = components['schemas']['EstimatedValue'];
